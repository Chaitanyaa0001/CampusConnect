...
const InternshipDetailPage: React.FC<Props> = ({
  internshipState,
  actionLabel = "Apply Now",
  actionLink,
  detailsTitle = "About this Listing",
  skillsTitle = "Tags",
}) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0A0F1C] text-gray-800 dark:text-gray-200 p-6 lg:p-16 flex flex-col gap-10">
      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-[#1A2234] rounded-xl shadow-lg p-8 flex flex-col gap-6">
        ...
        <div>
          <h2 className="text-xl font-semibold dark:text-white">{detailsTitle}</h2>
          <p className="text-gray-700 dark:text-gray-300">{description}</p>
        </div>

        <div>
          <h2 className="text-xl font-semibold dark:text-white">{skillsTitle}</h2>
