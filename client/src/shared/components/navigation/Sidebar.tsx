      ...
      >
        <div>
          ...
          <nav className="space-y-2">
            <Link href="/student/lost&found" className="flex items-center gap-3 p-2 rounded-lg hover:bg-blue-600 hover:text-white dark:text-white">
              <Home size={20} /> Lost & Found
            </Link>
            <Link href="/student/projects" className="flex items-center gap-3 p-2 rounded-lg hover:bg-blue-600 hover:text-white dark:text-white">
              <Compass size={20} /> Project Collaboration
            </Link>
            <Link href="/student/messages" className="flex items-center gap-3 p-2 rounded-lg hover:bg-blue-600 hover:text-white dark:text-white">
              <Home size={20} /> messages
            </Link>
            <Link href="/student/carental" className="flex items-center gap-3 p-2 rounded-lg hover:bg-blue-600  hover:text-white dark:text-white">
              <Briefcase size={20} /> Car Rental
            </Link>
            <Link href="/student/carpool" className="flex items-center gap-3 p-2 rounded-lg hover:bg-blue-600 hover:text-white dark:text-white">
              <Upload size={20} /> Carpool
            </Link>
            <Link href="/student/publichat" className="flex items-center gap-3 p-2 rounded-lg hover:bg-blue-600 hover:text-white dark:text-white">
